...
results<-bind_rows(list(Weinstein2019_results,Weinstein_unpublished_results,Silva2016_results,Dalponte2016_results,Li2012_results))
```
...
# How does the bounding box uncertainty relate to IoU overlap?

```{r}
qplot(df[["Weinstein_unpublished"]]$score)
```
